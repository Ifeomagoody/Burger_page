...
const BurgerCard = ({image, price, reviews, title}: Props) => {
  return (
    <div className="bg-white p-6 rounded-lg m-3 ">
     ...
     <h1 className="mt-[1.3rem] text-[23px] text-black font-semibold ">{title}</h1>     
     ...
     <p className="mt-[0.5rem] text-black text-opacity-70  ">It is a good time and Season to snack on how healthy and Satisfying Burger</p>
